...
const BoatBookingTransaction = sequelize.define(
  "BoatBookingTransaction",
  {
    ...
    start_trip_date: { type: DataTypes.DATEONLY, allowNull: true },
    start_trip_time: { type: DataTypes.TIME, allowNull: true },
    end_trip_date: { type: DataTypes.DATEONLY, allowNull: true },
    end_trip_time: { type: DataTypes.TIME, allowNull: true },
